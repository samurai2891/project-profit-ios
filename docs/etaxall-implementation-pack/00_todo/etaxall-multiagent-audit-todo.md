...
- 非破壊検証:
  ...
  - ローカル実行証跡: `docs/etaxall-implementation-pack/02_evidence/etax-ci-local-evidence-2026-02-26.md`
  ...
  - GitHub実行証跡ドキュメント: `docs/etaxall-implementation-pack/02_evidence/etax-ci-gh-evidence-2026-02-26.md`
...
- 根拠:
  ...
  - `docs/etaxall-implementation-pack/02_evidence/etax-ci-gh-evidence-2026-02-26.md`
- 影響:
